...
function Resume3() {
  ...
  return (
    ...
    <div className="container mt-5" id="resume-content">
      <header className=" text-white py-4 px-3 " style={{backgroundColor: '#58677a'}}>
      ...
      <div className="row">
        {/* Left Column */}
        <div className="col-md-6" style={{backgroundColor : '#ececec', height: '900px',width:'49%',paddingTop:'15px',marginLeft:'10px'}}>
          {/* Work Experience */}
          <section>
