...
function Resume2() {
    ...
    return (
       ...
       <center>
        <div id="resume-content" className="mb-5 p-4 w-100" style={{border:"5px solid #ebc2c2", backgroundColor:"biege"}}>
           

        <div style={{backgroundColor:'#ebc2c2'}}>
        ...
        <hr style={{height:"15px",backgroundColor:"#ebc2c2"}}/>
        ...
        <div className="container" style={{fontFamily:"Serif",}}>
            ...
            <div className="col-3 text-left  " style={{color:"#ebc2c2"}}> <h4> Experience</h4></div>
            <div className="col-9  text-left " style={{fontSize:"18px"}}>
                ...
                <hr style={{height:"5px",backgroundColor:"#ebc2c2"}}/>

                <div className="col-3 text-left  " style={{color:"#ebc2c2"}}> <h4> Projects</h4></div>
                <div className="col-9  text-left " style={{fontSize:"18px"}}>
                ...
                <hr style={{height:"15px",backgroundColor:"#ebc2c2"}}/>
                <div className="col-3 text-left" style={{color:"#ebc2c2"}}><h4>Education</h4></div>
                ...
                <div className="col-3 text-left " >
                    <h4 style={{color:"#ebc2c2"}}>Key Skills</h4>
                </div>
                <div className="col-9 text-left" style={{fontSize:"18px"}}>
                ...
                <div className="col-3 text-left  " style={{color:"#ebc2c2"}}> <h4> Certification</h4></div>
            <div className="col-9  text-left " style={{fontSize:"18px"}}>
                ...
                <hr style={{height:"15px",backgroundColor:"#ebc2c2"}}/>
                <div className="col-3 text-left " >
                    <h4 style={{color:"#ebc2c2"}}>Languages</h4>
                </div>
                <div className="col-9 text-left" style={{fontSize:"18px"}}>
        ...
        <div className="col-3 text-left 
                         ...
                         " >
                                     <h4 style={{ color: "#ebc2c2" , marginLeft : '1000px',marginTop: '200px' }}>Date</h4>
                                 </div>
                         <div className="col-9 text-left" style={{ fontSize: "18px", 
                             marginLeft : '1000px'
                         }}>
